  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 max-w-4xl">
      ...
      <div className="flex items-center gap-3">
        <Link href={`/invoices/${id}`} className="p-2 rounded-lg text-slate-400 hover:bg-slate-100 transition-colors">
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Ndrysho Faturën</h1>
          <p className="text-slate-500 text-sm mt-0.5">Edito të gjitha të dhënat e faturës</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="sm:col-span-2">
              ...
              <select value={clientId} onChange={(e) => setClientId(e.target.value)} required
                className="w-full px-3.5 py-2.5 border border-slate-200 rounded-lg text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white"
              >
